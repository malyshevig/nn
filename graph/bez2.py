    ...
    def __init__(self,  xy1, xy2, label=""):
        ...
        class Deviation:
            ...
            def __call__(self, *args, **kwargs):
                return abs(np.random.normal(0, self.d))

        d = Deviation(5)

        self.lines = []
        self.lines.append(Line( (voice(x1, d()), voice(y1, d())), (voice(x1,d()), voice(y2,d()))))
        self.lines.append(Line( (voice(x1, d()), voice(y1, d())), (voice(x2,d()), voice(y1,d()))))
        self.lines.append(Line( (voice(x1, d()), voice(y2, d())), (voice(x2,d()), voice(y2,d()))))
        self.lines.append(Line( (voice(x2, d()), voice(y1, d())), (voice(x2,d()), voice(y2,d()))))
